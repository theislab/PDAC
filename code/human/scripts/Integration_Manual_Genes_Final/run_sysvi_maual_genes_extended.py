...
def train_sysvi_model(adata, system_key='Dataset', condition_key='Condition', max_epochs=200, embed_save_path='sysVI/sysVI_dataset_reference_latent.h5ad',
    ...
    try:
        ...
        adata.obsm['X_umap_sysvi'] = adata.obsm['X_umap']
        adata.write(embed_save_path)
...
adata = sc.read_h5ad('/home/aih/shrey.parikh/PDAC/PDAC_Final/concatenated/adata_manual_genes_extended.h5ad')
print(adata)
adata.X = adata.layers['raw'].copy()

print("Starting scVI training...")
print("Starting sysVI training...")
train_sysvi_model(
    adata=adata,
    system_key='ID_batch_covariate',
    condition_key='Condition',
    max_epochs=200,
    embed_save_path='/home/aih/shrey.parikh/PDAC/PDAC_Final/EMG_Embedding/sysVI/sysvi_manual_genes_extended_default.h5ad',
    model_save_path='/home/aih/shrey.parikh/PDAC/PDAC_Final/EMG_Embedding/sysVI/sysvi_manual_genes_extended_default'
)
